...
<strong>by <a href="mailto:webster@concrescent.net"> Sam Webster</a> ©1991</strong>
...
But the vault is still the tomb, a hall of the dead. This kind of symbolism is plainly unsuited for the current aeon, however potent for the last. Also building an object with seven 8 x 5 foot walls and a ceiling and floor to match makes an unwieldy structure that is far from portable. The following is
a record of a new version of the Vault of the Adepti called the 'House of Khabs' that has been found effective in the initiation of adepts and for adept-class magick.

With a little ethnographic study it becomes evident that birth symbolism can be substituted for death. Also, 'ephemeralizing' the structure would be in keeping with the general flow of technical advancement both within the magickal community and without. This term is taken from R. Buckminster Fuller who uses it to describe the pattern he noted that we are constantly doing more
with less. The best example of this is the pocket calculator which was once as large as a radio and very expensive and now is the size of a credit card and given away. Fuller's geometries give us the ability to ephemeralize the Vault of the Adepti and thereby form the House of Khabs.
...
Again they consulted the ROTA, as they had of old, and came to an understanding. They learned that the formulae of initiation had changed with the revolution of the Aeons. That the Way was not of Death but of Birth and the Founder had passed on to be Born again. They also learned that the Portal would not again open for Two Hundred and Ten years, until the Keys of the New Aeon had been discovered and used…”</blockquote>
Thus everything is changed. As for the direct application of birth symbolism in the rite, we shall leave that to its initiates, let us just say reborn in the House of Khabs. However, the physical structure of the House of Khabs is easy to discuss along with some of its attendant symbolism. As a whole, it is based on the fundamental geometric shapes that the Egyptians, and Assyrians and Plato all referred to and used, slightly modified by Fuller's synergetic outlook. I refer you to Plato's Timaeus for the foundational texts of this method as well as Fuller's Synergetics I &amp; II for a more modern explanation of these forms.
<p align="center"><img src="http://www.hermetic.com/webster/images/web-fig-1.gif" border="2" height="331" hspace="10" vspace="10" width="454" /></p>
The House of Khabs ("and Khabs is the name of my house", L. AL) is a structure built of three portions. The outermost is a tetrahedron, the minimum form in normal space. It is the overarching body of Nuit and delimits the space. It is made by a tripod of three poles and the ground on which it is
placed. Ropes are run between the vertices on the ground providing the definition of the basal triangle. To each of the basal vertices is attributed a mother letter of the Hebrew alphabet. To most of the rest of the vertices (of the rest of the structure we will describe) will be attribute each of the
rest of the Hebrew alphabet. Naturally, this alludes to the yetzeratic and tarot attributions of which the letters are hieroglyphs.
...
If you take a bowl and drop into it seven eggs, they will most likely arrange themselves in a hexagon with one in the middle. This describes the equatorial plane of the IVEM (remember, this being a regular shape, there are a variety of planes that could be similarly produced that would all have the
same shape). Holding the hexagon stable, add imaginatively three spheres above this plane and three spheres below. They will naturally arrange themselves so as to form a hexagram if you were to line them up on the opposites sides of the equatorial plane. Connecting the centers of these spheres will give you the structure 1 am trying to describe.

This shape is considered by Fuller to be the essential structure governing the interpatterning of all other structures. Of this archetypal form Fuller says that if 'God' has a shape, this is it. Being so sanctified, this shape is referred to ritually as the Sphere of Qadosh. Having twelve vertices, we
attribute to each of them the twelve simple letters assigned to the zodiac. Upon examination it may be noticed that each of the vertices can be taken in turn, one at a time, if one begins at a single point and proceeds to orbit the shape in a circle parallel to the chosen equatorial plane. Thus the zodiac,
normally seen as a plane, can be attributed regularly about the IVEM. One point to note is exactly where one starts the orbit. This determines the location of the zodiacal signs in the House of Khabs. The dominant question is whether to place Heh-Aries in the East, which puts Lamed-Libra in the West, the entrance; or Tzaddi-Aquarius, which puts Teth-Leo in the West. I'll leave the exegesis of this to the reader.

One other attribution of this structure is formed by the rings that make up is edges. Besides the above description, this shape could be formed by four hexagons intersecting their centers in planes at 60* to each other. These could be attributed elementally, but as this structure alludes to more generalizable forms than the elements, we have attributed it to the three base colors: Black, white and red and also green for life. Students of comparative religions will recognize the prevalence and import of these colors. Students of the Golden Dawn will recognize their use in many GD ritual contexts. These
relate also to certain embodiments of the powers of which the colors are the signatures used by initiates of this order. One of their principle purposes is to stabilize orbitals in the aura of the adepti employing these forms.
...
<hr />
<p align="right">E-mail the author at <a href="mailto:webster@concrescent.net">webster@concrescent.net</a>.</p>
